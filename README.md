...
-   add a bx binary as a second output binary target
...
I forked this for my own usage.
Also, since I'm currently starting to dabble in the rust world,
I want to contribute back to the original project if I manage some meaningful improvements!
